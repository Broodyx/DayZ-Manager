...
<style>
    ...
    .dz-map-intro { display:flex; flex-wrap:wrap; align-items:center; gap:.4rem; margin:0 0 .7rem; padding:.5rem .7rem; border:1px solid #34472d; border-radius:.45rem; background:#111a14; font-size:.78rem; }
    .dz-map-intro > b { color:#e7f7d2; }
    .dz-map-intro-chip { padding:.2rem .55rem; border:1px solid #3f5636; border-radius:1rem; background:#182417; color:#d8f57b; font-size:.72rem; font-weight:700; cursor:help; }
    .dz-map-intro > small { margin-left:auto; color:#9aa99b; }
    ...
    .dz-item-list-row { display:grid; grid-template-columns:minmax(0,2fr) repeat(3,minmax(0,1fr)) minmax(3.6rem,auto) auto; gap:.4rem; align-items:center; }
    .dz-item-list-row input { min-height:2.3rem !important; }
    .dz-item-list-space { justify-self:end; padding:.15rem .5rem; border-radius:.4rem; background:#1c2410; color:#c9d79a; font-size:.68rem; font-weight:750; text-align:center; white-space:nowrap; }
    ...
    .dz-cargo-capacity-summary { display:grid; gap:.2rem; margin-top:-.2rem; padding:.5rem .7rem; border:1px solid #3a4a2e; border-radius:.5rem; background:#131c10; color:#a9bb98; font-size:.72rem; }
    .dz-cargo-capacity-summary:empty { display:none; }
    .dz-cargo-capacity-summary.dz-cargo-capacity-over { border-color:#8a3a30; background:#241412; color:#e3b6ac; }
    .dz-cargo-capacity-alert { color:#ffb3ac; font-weight:800; }
    .dz-cargo-capacity-suggest { color:#f0d488; }
    ...
    .dz-source-ftp { border-color:#4a7a3a !important; color:#c9f2b0 !important; }
    ...
    .dz-upload-drop { padding:.9rem; border:1px dashed #526348; border-radius:.6rem; background:#0a100c; transition:border-color .15s,background .15s; }.dz-upload-drop input { padding:0 !important; border:0 !important; min-height:auto !important; }.dz-upload-drop > span { color:#748178 !important; font-size:.67rem; }.dz-upload-drop b { width:max-content; padding:.35rem .45rem; border-radius:.35rem; color:#ffe0c2; background:#362113; font-size:.66rem; }
    .dz-upload-drop-active { border-color:#b8ed55; background:rgba(182,233,79,.06); }
    .dz-upload-browse-button { display:grid; gap:.25rem; padding:.9rem 1rem; margin-bottom:.6rem; border:1px solid #486a2c; border-radius:.5rem; background:#151e17; color:#b6e94f; font-weight:800; cursor:pointer; text-align:center; }
    .dz-upload-browse-button:hover { background:#1a2a1c; }
    .dz-upload-browse-button small { color:#9aa99b; font-weight:400; }
    #dz-files-input { position:absolute; width:1px; height:1px; overflow:hidden; opacity:0; }
    .dz-upload-file-list { list-style:none; margin:.75rem 0 0; padding:.6rem .75rem; display:grid; gap:.3rem; border-radius:.4rem; background:#111a14; border:1px solid #34472d; max-height:12rem; overflow-y:auto; }
    .dz-upload-file-count { color:#d8f57b; font-weight:800; font-size:.75rem; }
    .dz-upload-file-list li:not(.dz-upload-file-count) { color:#cbd5c0; font-size:.75rem; overflow-wrap:anywhere; }
    ...
    .dz-weather-presets { display:flex; align-items:center; gap:.5rem; flex-wrap:wrap; }
    ...
    .dz-log-history { border:1px solid #2c3d2e; border-radius:.55rem; background:#0c130e; padding:.1rem 1rem; }
    .dz-log-history summary { cursor:pointer; padding:.75rem 0; color:#d8f57b; font-weight:800; font-size:.85rem; display:flex; align-items:center; gap:.5rem; }
    .dz-log-history summary small { padding:.1rem .5rem; border-radius:999px; background:#1a241a; color:#aab6a4; font-size:.7rem; font-weight:800; }
