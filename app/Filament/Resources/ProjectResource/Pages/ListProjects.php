    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('demo')
                ...
                ->modalHeading('Vytvořit ukázkové DayZ projekty?')
                ->modalDescription('Přidá nebo aktualizuje tři bezpečné demo projekty pro váš účet. Vaše existující projekty nesmaže.')
                ->action(function (): void {
                    ...
                    Notification::make()
                        ...
                        ->body('Byly vytvořeny projekty Chernarus, Livonia a Namalsk.')
                        ->send();
                }),
            Actions\CreateAction::make()->label('Nový projekt'),
        ];
    }
}
